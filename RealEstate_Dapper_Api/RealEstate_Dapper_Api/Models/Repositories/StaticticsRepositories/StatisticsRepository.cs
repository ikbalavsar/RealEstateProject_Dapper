...
namespace RealEstate_Dapper_Api.Models.Repositories.StaticticsRepositories
{
    public class StatisticsRepository : IStatisticsRepository
    {
        ...
        public string CategoryNameByMaxProductCount()
        {
            string query = "Select top(1) CategoryName,Count(*) From Product " +
                "inner join Category On Product.ProductCategory=Category.CategoryID Group By CategoryName order by Count(*) Desc";
            using (var connection = _context.CreateConnection())
            {
        ...
        {
            string query = "Select Name, Count(*) 'product_count' From Product Inner Join Employee " +
                "on Product.EmployeeID = Employee.EmployeeID Group By Name Order By product_count Desc";
            using (var connection = _context.CreateConnection())
            {
                var values = connection.QueryFirstOrDefault<string>(query);
                return values;
